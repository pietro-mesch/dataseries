...
#End Region
    ...
    Public Class BinaryHeapHighFirst(Of Rank As IComparable, T)

        Private _sortOrder As Integer = -1 '1 = ASC, -1 = DESC
...
#Region "PUBLIC METHODS"
        ...
        ''' <param name="c"></param>
        ''' <remarks></remarks>
        Public Sub Insert(obj As T, c As Rank)
            'increase tree size counter
            _mySize += 1
...
#Region "PRIVATE METHODS"
        ...
        Private Sub percUp()
            ...
            While i2 > 0 AndAlso _myTree(i).CompareTo(_myTree(i2)) * _sortOrder < 0
                tmp = _myTree(i2)
        ...
        Private Sub percDown()
            ...
            While (i * 2) <= _mySize AndAlso _myTree(i).CompareTo(_myTree(mc)) * _sortOrder > 0
        ...
        ''' <summary>
        ''' return index of best child of node i according to the sorting order
        ''' </summary>
        ''' <param name="i"></param>
        ''' <returns></returns>
        ''' <remarks></remarks>
        Private Function BestChild(i As Integer) As Integer
            ...
            If i2 + 1 > _mySize Then
                Return i2
            Else
                If _myTree(i2).CompareTo(_myTree(i2 + 1)) * _sortOrder < 0 Then
                    Return i2
                Else
                    Return i2 + 1
                End If
...
#End Region
        ...
        Private Class Pair
            ...
            Private _c As Rank
            Public ReadOnly Property c As Rank
                Get
                    Return Me._c
                End Get
            End Property
            ...
            Public Sub New(cost As Rank, obj As T)
                _c = cost
                _o = obj
            End Sub
